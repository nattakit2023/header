        ...
        <?php foreach ($package as $item) : ?>
            ...
            <tr id="row<?= $item->id; ?>">
                ...
                <td class="text-center">
                    ...
                    <button onclick="edit('<?= $item->id; ?>')" id="<?= $item->id; ?>" type="button" class="btn btn-success btn-sm rounded-0" data-toggle="modal" data-target="#modalEditPackage"><i class="fas fa-edit"></i></button>
