        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <h3><i class="fas fa-tools"></i><strong> Create CM</strong></h3>
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create CM</li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <button id="createCM" class="btn btn-primary rounded-0">Create</button>
...
<script>
    ...
    $(document).on('click', '#createCM', function() {
                            ...
                            success: function(res) {
                                ...
                                if (res.status == 'SUCCESS') {
                                    ...
                                    setTimeout(function() {
                                        ...
                                        window.location.assign('<?= base_url(); ?>pages/report/cm_cre');
